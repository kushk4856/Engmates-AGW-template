...
if(isset($_REQUEST['submit'])) 
{
    ...
    // $email_to = "engmates.tilaknagar@gmail.com, rk.abhishekbakshi@gmail.com, 4exult@gmail.com";
    $email_subject = "Query from Basic English Speaking Classes Long LP (Bottom Form)";
    ...
    $message = $_POST['message'] ?? 'N/A'; // required
    ...
    @$email_message .= "Alternate Number: " . clean_string($alternateNumber) . "\n";
