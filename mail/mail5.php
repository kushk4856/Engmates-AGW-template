...
if (isset($_POST['submit'])) {
    ...
    $email_to = "himanshu.lifelinkr@gmail.com, dm.shrutisharma@gmail.com"; // Admin emails
    $email_subject = "Query from LifeLinkr.com Calendar Page";

    // Sanitize and assign POST data to variables
    $name = $_POST['name']; // required
    $company_email = $_POST['email']; // required
    $phone = $_POST['phone']; // required
    $alternateNumber = $_POST['alter_num'] ?? 'N/A';
    $city = $_POST['city'];
    ...
    $calendar_url = "https://www.google.com/calendar/render?action=TEMPLATE&text=Your%20Consultation%20With%20Engmates%20is%20Scheduled%20|%20" . urlencode($selected_date) . ",%20" . urlencode($selected_time) . "%20(Indian%20Standard%20Time)&dates=$start_date_time/$end_date_time&details=Details%20from%20your%20form&location=Clinic%20Location";
    ...
    $email_message_user = "
        ...
        <p>Thank you for booking your free consultation with Engmates! We’re thrilled to connect with you and discuss how we can help you achieve your English and Public speaking skills.</p>
        ...
        <p>To make it easier to manage your schedule, you can add this session to your calendar using the link below:</p>
        ...
        <p>Our expert team will reach out to you soon to understand your learning objectives and tailor the consultation to your needs.</p>
        <p>If you have any questions or need to reschedule, simply reply to this email or contact us directly at 9311811011.</p>
        <p>We’re excited to help you take the first step towards a confident and successful life.</p>
        <p>Best regards,<br>Team Engmates</p>
    ";

    // Prepare email message for the admins
    $email_message_admin = "
        ...
        <p><strong>Alternate Number:</strong> " . clean_string($alternateNumber) . "</p>
        <p><strong>Location:</strong> " . clean_string($city) . "</p>
    ...
    if (@mail($company_email, "Your Consultation with Engmates is Scheduled @ $selected_date_time (Indian Standard Time)", $email_message_user, $headers)) {
        echo "User email sent successfully.";
    } else {
        echo "Failed to send user email.";
    }
...
<script>
    ...
    setTimeout(function(){
    window.location.href='https://www.engmates.in/';
},8000); 
}
</script>
