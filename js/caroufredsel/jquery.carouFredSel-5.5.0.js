(function ($) {
  ...
  $.fn.carouFredSel = function (options, configs) {
    ...
    $cfs._cfs_init = function (o, setOrig, start) {
      ...
      if (o.debug) {
        ...
        debug(
          conf,
          'The "debug" option should be moved to the second configuration-object.'
        );
      }
      ...
      if (typeof opts.items.filter == "undefined") {
        opts.items.filter =
          all_itm.filter(":hidden").length > 0 ? ":visible" : "*";
      }
      if (opts[opts.d["width"]] == "auto") {
        opts[opts.d["width"]] = ms_getTrueLargestSize(
          all_itm,
          opts,
          "outerWidth"
        );
      ...
      if (opts[opts.d["height"]] == "auto") {
        opts[opts.d["height"]] = ms_getTrueLargestSize(
          all_itm,
          opts,
          "outerHeight"
        );
      ...
      if (!opts.items[opts.d["width"]]) {
        if (opts.responsive) {
          ...
          opts.items[opts.d["width"]] = ms_getTrueLargestSize(
            all_itm,
            opts,
            "outerWidth"
          );
        } else {
          opts.items[opts.d["width"]] = ms_hasVariableSizes(
            all_itm,
            opts,
            "outerWidth"
          )
      ...
      if (!opts.items[opts.d["height"]]) {
        opts.items[opts.d["height"]] = ms_hasVariableSizes(
          all_itm,
          opts,
          "outerHeight"
        )
      ...
      if (!opts.items.visible && !opts.responsive) {
        ...
        if (!opts.items.visibleConf.variable) {
          if (typeof opts[opts.d["width"]] == "number") {
            opts.items.visible = Math.floor(
              opts[opts.d["width"]] / opts.items[opts.d["width"]]
            );
          } else {
      ...
      if (opts.responsive) {
        ...
        var fullS = ms_getPercentage(
          ms_getTrueInnerSize($wrp.parent(), opts, "innerWidth"),
          opts[opts.d["width"]]
        );
        if (
          typeof opts[opts.d["width"]] == "number" &&
        ...
        var visb = cf_getItemAdjustMinMax(
          Math.ceil(fullS / opts.items[opts.d["width"]]),
          opts.items.visibleConf
        );
        ...
        switch (opts.align) {
          ...
          case "right":
            if (opts[opts.d["width"]] != "variable") {
              var p = cf_getAlignPadding(
                gi_getCurrentItems(all_itm, opts),
                opts
              );
      ...
      if (typeof opts.scroll.items == "undefined")
        opts.scroll.items =
          opts.items.visibleConf.variable || opts.items.filter != "*"
            ? "visible"
            : opts.items.visible;
      ...
      if (
        typeof opts.pagination.anchorBuilder != "function" &&
      ...
      if (typeof opts.auto.pauseDuration != "number")
        opts.auto.pauseDuration =
          opts.auto.duration < 10 ? 2500 : opts.auto.duration * 5;
      if (opts.synchronise) {
      ...
      if (conf.debug) {
        ...
        if (opts.maxDimention)
          debug(
            conf,
            "Available " + opts.d["width"] + ": " + opts.maxDimention
          );
    ...
    $cfs._cfs_bind_events = function () {
      ...
      $cfs.bind(cf_e("_cfs_slide_prev", conf, false), function (e, sO, nI) {
        ...
        if (opts.usePadding) {
          ...
          if (pR >= 0) {
            ...
            a_new[opts.d["marginRight"]] =
              l_new.data("cfs_origCssMargin") + opts.padding[opts.d[1]];
        ...
        cf_setCookie(
          opts.cookie,
          $cfs.triggerHandler(cf_e("currentPosition", conf))
        );
      ...
      $cfs.bind(cf_e("_cfs_slide_next", conf, false), function (e, sO, nI) {
        ...
        opts.items.visibleConf.old = opts.items.visible;
        if (opts.items.visibleConf.variable) {
          var vI = gn_getVisibleItemsNextTestCircular(
            a_itm,
            opts,
            nI,
            lastItemNr
          ...
          while (opts.items.visible - nI >= vI && nI < itms.total) {
            nI++;
            vI = gn_getVisibleItemsNextTestCircular(
              a_itm,
              opts,
              nI,
              lastItemNr
        ...
        var a_complete = function () {
          ...
          if (opts.usePadding) {
            if (itms.total < opts.items.visible + nI) {
              ...
              l_cur.css(
                opts.d["marginRight"],
                l_cur.data("cfs_origCssMargin") + opts.padding[opts.d[3]]
              );
            }
            l_itm.css(opts.d["marginRight"], l_itm.data("cfs_origCssMargin"));
          }
      ...
      $cfs.bind(cf_e("updatePageStatus", conf), function (e, build, sizes) {
        ...
        opts.pagination.container.each(function () {
          $(this)
            ...
            .eq($cfs.triggerHandler(cf_e("currentPage", conf)))
  ...
  function fx_uncover(sc, c1, c2, o, prev, n) {
    var new_w = ms_getSizes(
        gi_getNewItemsNext(c1.children(), o, n),
        o,
        true
      )[0],
  ...
  function nv_showNavi(o, t, c) {
    if (t == "show" || t == "hide") {
      ...
      debug(
        c,
        "Not enough items: hiding navigation (" +
          t +
          " items, " +
          o.items.minimum +
          " needed)."
  ...
  function sz_resetMargin(i, o, m) {
    ...
    i.each(function () {
      ...
      j.css(
        o.d["marginRight"],
        x ? j.data("cfs_tempCssMargin") : m + j.data("cfs_origCssMargin")
      );
    });
  }
  ...
  function ms_getTrueInnerSize($el, o, dim) {
    ...
    var siz = $el[o.d[dim]](),
      arr =
        o.d[dim].toLowerCase().indexOf("width") > -1
